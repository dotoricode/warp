...
use super::bundled::{BundledSkill, BundledSkills, RemoteBundledSkillBootstrap};
...
impl SkillManager {
    ...
    pub(super) fn begin_remote_bundled_skill_bootstrap(
        &mut self,
        host_id: HostId,
    ) -> Option<RemoteBundledSkillBootstrap> {
        self.bundled_skills.begin_remote_bootstrap(host_id)
    }

    pub(super) fn complete_remote_bundled_skill_bootstrap(
        &mut self,
        bootstrap: RemoteBundledSkillBootstrap,
        bundled_skill: BundledSkill,
    ) -> bool {
        self.bundled_skills
            .complete_remote_bootstrap(bootstrap, bundled_skill)
    }
